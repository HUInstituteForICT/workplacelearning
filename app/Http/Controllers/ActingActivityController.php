...
class ActingActivityController extends Controller {
    ...
    public function create(Request $req) {
        ...
        $v = Validator::make($req->all(), [
            ...
            'description'           => 'required|max:150|regex:/^[ 0-9a-zA-Z\-_,.?!*&%#()\/\\\\\'"\s]+\s*$/',
            ...
            'learned'               => 'required|max:150|regex:/^[ 0-9a-zA-Z\-_,.?!*&%#()\/\\\\\'"\s]+\s*$/',
            'support_wp'            => 'max:75|regex:/^[ 0-9a-zA-Z\-_,.?!*&%#()\/\\\\\'"\s]+\s*$/',
            'support_ed'            => 'max:75|regex:/^[ 0-9a-zA-Z\-_,.?!*&%#()\/\\\\\'"\s]+\s*$/',
