            ...
            <div class="col-lg-5">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input name="numhours" step="0.5" type="number" max="24" class="form-control"
                                   placeholder="{{ Lang::get('elements.profile.internships.numhours') }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <select @if($period->cohort !== null) readonly="true" disabled @endif class="form-control"
                                    name="cohort">
                    ...
                    <table class="table blockTable">
                        ...
                        <tr>
                            ...
                            <td><input name="newcat[0][cg_label]"
                                       placeholder="{{ Lang::get('elements.profile.placeholders.categoryname') }}"
