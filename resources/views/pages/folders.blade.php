...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @card
        <h1>{{ __('folder.folders') }} <a class="btn btn-info right" data-target="#addFolderModel"
                                          data-toggle="modal">{{ __('folder.create-folder') }}</a></h1>
                                    ...
                                    @if (count($folder->savedLearningItems))
                                        ...
                                        <section class="section">
                                            <h5>{{ __('folder.added-items') }} <span
                                                        class="badge">{{ count($folder->savedLearningItems)}}</span>
                                            </h5>
                ...
                <div class="modal-body">
                    ...
                    <p>Kies maximaal drie items om aan deze map toe te voegen.
                        <i class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" data-placement="bottom"
                           title="{{ __('folder.items-limit-hint') }}"></i>
                    </p>
