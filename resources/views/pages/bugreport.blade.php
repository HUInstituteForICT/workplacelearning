        ...
        <div class="row">
            <div class="col-md-6">
                ...
                {!! Form::open(array('id' => 'taskForm', 'class' => 'form-horizontal well', 'url' => URL::to('bugreport/create', array(), true))) !!}
                    ...
                    <textarea name="uitleg" cols="80" rows="10" placeholder="Bijvoorbeeld: Ik zou graag een andere rapportage terugzien op de analyse pagina. Kan deze worden toegevoegd?"></textarea><br />
