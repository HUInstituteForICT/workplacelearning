...
return [
    ...
    "form" => [
        ...
        "tipText" => "Text of the tip. Use the value parameters below (:value-x) to mark where the calculated statistic values should be placed.",
        "tipTextPlaceholder" => ":value-1 of your activities you do alone.",
        ...
        'statistic-value-parameters' => 'Value parameters for this tip',
