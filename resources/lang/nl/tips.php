...
return [
    ...
    'couple-moment' => 'Koppel nieuw moment',
    'create' => 'Maak aan',
    'or' => 'of',
    'percentage-period' => 'Tussen :percentage van stageperiode',
    ...
    'help-steps' => [
        ...
        '17' => 'Hier kun je instellen tijdens welke periodes van de stage deze tip actief mag zijn, bijvoorbeeld alleen aan het begin. Als de tip altijd actief mag zijn hoef je niks in te stellen!',
        '18' => 'Stel nu de tekst in die aan een student getoond moet worden als de tip actief is. Je kunt de berekende waardes van de statistieken hier invoegen door ":statistic-*" te typen, waar de * het nummer van de statistiek is. Deze nummers kun je in de tabel vinden.',
        '19' => 'Stel de zichtbaardheid van de tip voor studenten in.',
        '20' => 'Selecteer de cohorten waar de tip actief mag zijn.',
        '21' => 'De laatste stap: sla de tip op.',
    ],

    'help' => [
        'help'             => 'Help',
        'how-does-it-work' => 'Hoe werkt het?',
        'explain-tips'          => 'Tips kunnen studenten helpen met hun werkplek. Deze tips dienen eerst hier aangemaakt te worden. Een tip wordt getoond aan een student als deze tip actief is. Een statistiek tip wordt actief doordat één of meerdere berekende statistieken een grenswaarde passeren en actief worden. Indien meerdere statistieken gekoppeld zijn dienen zij allemaal actief te zijn voordat de tip actief wordt. Een moment tip wordt actief als de stageperiode voor, bijvoorbeeld, 25% tot 35% gevorderd is in dagen.',
        ...
        'explain-moment' => 'Een moment heeft een start- en eindgrens. Samen bepalen zij wanneer een tip actief wordt. Bijvoorbeeld, door 25% en 35% in te vullen zal de tip actief worden als de student voor 25% tot 35% klaar is met de stageperiode.',
        'explain-tiptext' => 'De tip tekst is de tekst die getoond wordt aan een student. Bij een statistiek tip is het mogelijk om de berekende statistieken weer te geven met ":statistic-*" waar * het nummer is van de statistiek. Zo kan een student bijvoorbeeld weten wat zijn of haar percentage werk "Alleen" is en zich hier op aanpassen. Als het een moment tip betreft kun je ":days-percentage" invoeren om het berekende dagen percentage in de tip tekst te zetten.',
