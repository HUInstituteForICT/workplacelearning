...
class WplUserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::select("GRANT SELECT ON cohorts TO 'wpldashboard'@'%';");
        \DB::select("GRANT SELECT ON resourceperson TO 'wpldashboard'@'%';");
        \DB::select("GRANT SELECT ON timeslot TO 'wpldashboard'@'%';");
