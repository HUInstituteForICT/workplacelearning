...
class AddAnalyticsConstraints extends Migration
{
    /**
    * Run the migrations.
    *
    ...
    */
    public function down()
    {
         ...
         \DB::select("REVOKE SELECT ON analyses TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT ON category TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT ON chart TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT ON competence TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT ON difficulty TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT ON educationprogram TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT ON educationprogramtype TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT ON learningactivityacting TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT ON learningactivityproducing TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT ON learninggoal TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT ON resourcematerial TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT ON status TO 'wpldashboard'@'%';");
 
         \DB::select("REVOKE SELECT (access_id) ON accesslog TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (session_id) ON accesslog TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (screen_width) ON accesslog TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (screen_height) ON accesslog TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (user_agent) ON accesslog TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (OS) ON accesslog TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (url) ON accesslog TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (timestamp) ON accesslog TO 'wpldashboard'@'%';");
 
         \DB::select("REVOKE SELECT (dl_id) ON deadline TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (dl_value) ON deadline TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (dl_datetime) ON deadline TO 'wpldashboard'@'%';");
 
         \DB::select("REVOKE SELECT (setting_id) ON usersetting TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (setting_label) ON usersetting TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (setting_value) ON usersetting TO 'wpldashboard'@'%';");
 
         \DB::select("REVOKE SELECT (wp_id) ON workplace TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (wp_name) ON workplace TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (street) ON workplace TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (housenr) ON workplace TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (postalcode) ON workplace TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (numberofemployees) ON workplace TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (town) ON workplace TO 'wpldashboard'@'%';");
 
         \DB::select("REVOKE SELECT (wplp_id) ON workplacelearningperiod TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (wp_id) ON workplacelearningperiod TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (startdate) ON workplacelearningperiod TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (enddate) ON workplacelearningperiod TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (nrofdays) ON workplacelearningperiod TO 'wpldashboard'@'%';");
         \DB::select("REVOKE SELECT (description) ON workplacelearningperiod TO 'wpldashboard'@'%';");
    }
}